...
def get_llm(config: dict[str, Any]):
	"""Get the language model. LLM module has been removed from browser-use."""
	raise RuntimeError('LLM support has been removed from browser-use. Use the browser-use CLI or MCP server for browser automation.')
...
async def run_auth_command():
	...
	print('Cloud sync has been removed.')
	sys.exit(0)
